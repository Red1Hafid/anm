...
class AbsencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create absence" do
    assert_difference("Absence.count") do
      post absences_url, params: { absence: { absence_type_id: @absence.absence_type_id, end_date: @absence.end_date, start_date: @absence.start_date, user_id: @absence.user_id } }
    end
  ...
  test "should update absence" do
    patch absence_url(@absence), params: { absence: { absence_type_id: @absence.absence_type_id, end_date: @absence.end_date, start_date: @absence.start_date, user_id: @absence.user_id } }
