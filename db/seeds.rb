...
default_user = User.create(matricule: "S1", first_name: "admin", last_name: "admin", email: "admin.admin@alithya.com", password: "123456", password_confirmation: "123456", role_id: 1, is_active: true, status: 2,
                           started_at: '2021-08-10', gender: "1", family_status: "Autre", job_title: "Directeur principal", home_adress: "Av mohamed V ...", phone_number: "+2126.......", confirmed_at: DateTime.now, is_started_at_confirmed: true)
...
Bank.create(user_id: 1, balance_furlough: 0.0, balance_open_additional_hour: 0, balance_open_additional_hour_off_days: 0)
...
default_user2 = User.create(matricule: "C7", first_name: "meryem", last_name: "sekkat", email: "meryem@gmail.com", password: "123456", password_confirmation: "123456", role_id: 2, is_active: true, status: 2,
            started_at: '2021-08-10', gender: "1", family_status: "Autre", job_title: "Directeur principal", home_adress: "Av mohamed V ...", phone_number: "+2126.......", confirmed_at: DateTime.now, is_started_at_confirmed: true)
...
Bank.create(user_id: 8, balance_furlough: 0.0, balance_open_additional_hour: 0, balance_open_additional_hour_off_days: 0)