...
default_user2 = User.create(matricule: "S2", first_name: "admin", last_name: "admin", email: "admin.admin@askida.com", password: "123456", password_confirmation: "123456", role_id: 1, is_active: true, status: 2,
...
default_user2 = User.create(matricule: "S3", first_name: "admin", last_name: "admin", email: "admin.admin@vo2group.com", password: "123456", password_confirmation: "123456", role_id: 1, is_active: true, status: 2,
